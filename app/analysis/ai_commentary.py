...
class SystemCommentaryGenerator:
    ...
    def generate_executive_brief(client_name, hlv_income, hlv_expense, retirement_corpus,
        ...
        <div class="analysis-card" style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border-left: 4px solid #0ea5e9;">
            ...
            <p> This analysis follows a conservative financial analysis approach. All goal projections are based on inflation-adjusted costs. Monthly contribution requirements are computed without dependence on investment return assumptions for funding. Any investment returns, if realized, may support or accelerate goal achievement but are not considered necessary for meeting projected requirements. This analysis represents a conservative scenario and does not incorporate optimized or return-based financial planning or investment strategies.</p>
    ...
    def generate_overall_conclusion(client_name, financial_score,
        ...
        <div class="analysis-card" style="background: linear-gradient(135deg, #fefce8 0%, #fef9c3 100%); border-left: 4px solid #ca8a04;">
            ...
            <p>This analysis presents a comprehensive evaluation of financial objectives. The analysis is based on a conservative, non-return-dependent methodology. Insurance protection evaluation indicates gaps of Rs {min(hlv_gap_income, hlv_gap_expense):,} based on selected methodology. Medical inflation at {medical_inflation}% annually versus general inflation at {inflation}% creates differential in healthcare purchasing power projections. Retirement corpus assessment shows gap of Rs {retirement_gap:,} requiring systematic monthly investments over {years_remaining:,} years. Child education (Rs {child_education_gap:,}) and marriage (Rs {child_marriage_gap:,}) gaps are presented with corresponding time horizons. Current Rs {net_worth:,} net worth and {savings_rate}% savings rate form the foundation for financial planning.</p>
